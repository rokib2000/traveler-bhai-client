...
const Newsletter = () => {
  return (
    <div className="p-6  md:w-2/3 xl:w-auto mx-auto flex flex-col xl:items-stretch justify-between xl:flex-row  items-center ">
      <div className="xl:w-1/3 md:mb-14 xl:mb-0 relative h-auto flex items-center justify-center">
        <img src="https://i.postimg.cc/vm6bSj3k/Newsletter.png" alt="Envelope with a newsletter" className="h-96 " />
      </div>
      <div className="w-full xl:w-2/3 xl:pl-40 xl:py-28">
